    ...
    if(isset($_GET["params"]) && $_GET["params"])
    {
        ...
        for ($i = 0; $i < count($params); $i++)
        {
            switch ($params[$i])
            {
                ...
                case "ana1":  echo(rotateHue(-30, $H, $S, $V)); break;
                case "ana2":  echo(rotateHue(-20, $H, $S, $V)); break;
                case "ana3":   echo(rotateHue(-10, $H, $S, $V)); break;
                case "ana4":   print($color); break;
                case "ana5":   echo(rotateHue(10, $H, $S, $V)); break;
                case "ana6":   echo(rotateHue(20, $H, $S, $V)); break;
                case "ana7":   echo(rotateHue(30, $H, $S, $V)); break;
                case "com1":  echo(rotateHue(150, $H, $S, $V)); break;
                case "com2":  echo(rotateHue(160, $H, $S, $V)); break;
                case "com3":   echo(rotateHue(170, $H, $S, $V)); break;
                case "com4":  echo(rotateHue(180, $H, $S, $V)); break;
                case "com5":   echo(rotateHue(190, $H, $S, $V)); break;
                case "com6":   echo(rotateHue(200, $H, $S, $V)); break;
                case "com7":   echo(rotateHue(210, $H, $S, $V)); break;
                ...
                case "tri1":  echo(rotateHue(120, $H, $S, $V)); break;
                case "tri2":  echo(rotateHue(120, $H, $S, $V, true)); break;
                case "tri3":  print($color); break;
                case "tri4":  echo(rotateHue(0, $H, $S, $V, true)); break;
                case "tri5":  echo(rotateHue(-120, $H, $S, $V)); break;
                case "tri6":  echo(rotateHue(-120, $H, $S, $V, true)); break;
            }   
